...
export default function ConnectPG() {
  ...
  const [stripeMode, setStripeMode] = useState('oauth') // 'oauth' or 'manual'
  ...
  const handleStripeOAuth = () => {
    toast('Stripe OAuth coming soon! Please use manual entry for now.')
  }
        ...
        <div style={{ padding: '32px 40px' }}>
            ...
            <div>
              ...
              {stripeMode === 'oauth' ? (
                <div style={{ textAlign: 'center', padding: '32px 24px' }}>
                  ...
                  <div style={{ background: '#f8f9ff', border: '1.5px solid #c7d2f0', borderRadius: '10px', padding: '14px', marginBottom: '24px', fontSize: '13px', color: '#555', textAlign: 'left' }}>
                    <div style={{ fontWeight: '700', color: '#0f3460', marginBottom: '8px' }}>PayCollect will be able to:</div>
                  ...
                  <button
                    ...
                    style={{ width: '100%', padding: '13px', background: '#635bff', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '15px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
                  >
                    <span>⚡</span> Connect with Stripe
                  </button>
                  <p style={{ fontSize: '12px', color: '#aaa', marginTop: '12px' }}>
                    Prefer to enter keys manually? <span onClick={() => setStripeMode('manual')} style={{ color: '#635bff', cursor: 'pointer', fontWeight: '600' }}>Click here</span>
                  </p>
                </div>
              ) : (
                <div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '24px', paddingTop: '20px', borderTop: '1px solid #f0f2f7' }}>
            ...
            <button
              ...
              disabled={connecting || (stripeMode === 'manual' && !tested && activeTab === 'stripe')}
              style={{
                flex: 2, padding: '12px',
                background: connecting ? '#ccc' : (stripeMode === 'manual' && !tested && activeTab === 'stripe') ? '#ccc' : '#e94560',
                color: '#fff', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: '700',
                cursor: connecting || (stripeMode === 'manual' && !tested && activeTab === 'stripe') ? 'not-allowed' : 'pointer'
              }}
            >
