...
const sendPaymentRequestEmail = async({ customerEmail, customerName, merchantName, amount, dueDate, paymentLink, description }) => {
        ...
        const mailOptions = {
                from: `"${merchantName} via PayCollect" <${process.env.EMAIL_USER}>`,
                to: customerEmail,
            ...
            <div style="max-width:560px; margin:40px auto; background:#fff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                ...
                <div style="padding:32px;">
                    ...
                    <p style="color:#555; font-size:14px; line-height:1.6; margin:0 0 24px;">
                        <strong>${merchantName}</strong> has sent you a payment request. Please review the details below and complete your payment at your earliest convenience.
                    </p>
                    ...
                    <div style="background:linear-gradient(135deg,#0f3460,#1a5ca8); border-radius:12px; padding:24px; text-align:center; margin-bottom:24px;">
                        ...
                        <div style="color:white; font-size:36px; font-weight:800; letter-spacing:-1px;">₱${formattedAmount}</div>
                    ...
                    <div style="text-align:center; margin-bottom:24px;">
                        <a href="${paymentLink}" style="display:inline-block; background:#e94560; color:white; text-decoration:none; padding:16px 40px; border-radius:10px; font-size:16px; font-weight:700; letter-spacing:0.3px;">
                            Pay Now →
                        </a>
                    </div>
                ...
                <div style="background:#f8f9ff; padding:20px 32px; text-align:center; border-top:1px solid #eee;">
                    <p style="color:#aaa; font-size:11px; margin:0;">
                        🔒 Secured by PayCollect · PCI DSS Compliant<br>
